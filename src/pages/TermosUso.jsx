...
import { FileText, Home, Mail, Phone, MessageCircle } from "lucide-react";
    ...
    content: (
      <>
        <p>
          ...
          <Link to="/politica-de-privacidade" className="inline-flex items-center rounded-full px-2.5 py-1 text-amber-300 no-underline transition-colors duration-200 hover:bg-amber-300/10 hover:text-amber-100">
